...
│
├── .nanorc                  # Configuration for nano text editor
│
├── .oh-my-zsh/              # Zsh framework – plugins, themes, core scripts, etc.
...
│   ├── .devcontainer/       # Dev container settings (e.g. for VS Code remote)
│   ├── .editorconfig        # Project-wide editor formatting rules
│   ├── .git/                # Git metadata if oh-my-zsh is tracked as a repo
│   ├── .github/             # GitHub-related config (e.g. issue templates)
│   ├── .gitignore           # Files to exclude from Git tracking
│   ├── .gitpod.Dockerfile   # Docker setup for Gitpod dev environments
...
│
├── .themes/                 # Custom GTK or shell themes
...
├── .zshrc                   # Main zsh shell configuration file
